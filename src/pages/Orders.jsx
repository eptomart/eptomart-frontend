                  ...
                  <div className="border-t p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm border-t pt-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 uppercase">{order.paymentMethod}</p>
                        <div className="mt-2 space-y-1">
                          <div className="flex justify-between"><span>Subtotal</span><span>{formatINR(order.pricing?.subtotal)}</span></div>
                          <div className="flex justify-between"><span>Shipping</span><span>{order.pricing?.shipping === 0 ? 'FREE' : formatINR(order.pricing?.shipping)}</span></div>
                          <div className="flex justify-between font-bold"><span>Total</span><span>{formatINR(order.pricing?.total)}</span></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="border-t pt-4">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          const el = document.getElementById(`timeline-${order._id}`);
                      ...
                      <div id={`timeline-${order._id}`} className="hidden bg-gray-50 rounded-xl">
