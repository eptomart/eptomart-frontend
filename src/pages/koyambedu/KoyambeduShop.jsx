...
export default function KoyambeduShop() {
  ...
  return (
    <div className="min-h-screen bg-green-50 pb-32">
      {/* Header */}
      <div style={{ background: 'linear-gradient(135deg,#14532d,#16a34a)' }} className="px-4 pt-10 pb-4 text-white">
        <div className="flex items-center gap-3 mb-3">
          <button onClick={() => navigate('/koyambedu')} className="text-white/80">
          ...
          <Link to="/koyambedu/cart" className="ml-auto relative">
      ...
      {/* Product grid */}
      <div className="px-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
